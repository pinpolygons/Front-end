  ...
  <div id="app" class="wrapper">
    ...
    <div id="content">
      <nav class="navbar navbar-expand navbar-dark bg-dark">
        ...
        <button @click.prevent="showSb()" type="button" id="sidebarCollapse" class="btn btn-info" v-if="currentUser">
        ...
        <div class="navbar-nav mr-auto">
          ...
          <li class="nav-item">
            <a href="/user" class="nav-link" v-if="currentUser">{{ $t("user")}}</a>
          </li>
        </div>
        <div class="navbar-nav ml-auto" v-if="!currentUser">
            <div class="nav-link item" v-for="lang in optionLangs" :key="lang.value" :value="lang.value" @click.prevent="callSetLangActions" >{{ lang.text }}</div>
        </div>
        <div class="navbar-nav ml-auto" v-if="currentUser">
          <li class="nav-item">
